...
/*
        ...
        */
        ...
        ?>
        <h3>Rascunho Folha</h3>
        <table class="table caption-top  table-bordered table-hover" id="tabelaescala">
            ...
            <tbody>
                ...
                $sqlserv = "SELECT c.carga_horaria, c.funcao_upa, c.titulo, f.fk_cargo, f.nome, ef.* FROM u940659928_siupa.tb_escala_funcionario as ef INNER JOIN u940659928_siupa.tb_funcionario AS f ON (ef.fk_funcionario = f.id) INNER JOIN u940659928_siupa.tb_cargo AS c ON (f.fk_cargo = c.id) WHERE ef.fk_escala=$idescala order by ef.posicao ASC, f.nome ASC, ef.id ASC";
                $buscaserv = new BD;
                ...
                foreach ($resultadoserv as $serv) {
                    ...
                    $nomeexemplo = "<tr id='$serv->id'><th scope='row' class='editafuncionario nome_funcionario table-md $serv->id' data-idef='$serv->id' data-idf='$serv->fk_funcionario' data-nomeservidor='$nome' data-posicao='$serv->posicao'><div>$nome <span class='cargo_servidor'>$serv->titulo</span> <span class='cargo_servidor'>Carga Horária: $serv->carga_horaria</span></div> <span class='dados_folha'>Extras:<span class='horarios'>06h:___</span>  <span class='horarios'>12h:___</span>  <span class='horarios'>24h:___</span>  <span class='horarios'>Transf:___</span> <span class='horarios'>Acionamentos:___</span> <div><span class='adc_noturno'>Adicional Noturno:⃝ Sim    ⃝Não   | Faltas:____ Atestados:____</span></span>";
                    ...
                    for ($i = 1; $i <= $qtddias; $i++) {
                        ...
                        echo "<td id='dia$i' class='dia$i editadia align-middle $idlinha' data-toggle='tooltip' data-placement='bottom' data-idlinha='$idlinha' data-dia='d$i' title='Dia $i | $diadasemanaext ' $tamanholetra>";
